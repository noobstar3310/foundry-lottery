...
contract RaffleTest is CodeConstants, Test {
    ...
    function testRaffleIsInOpenStateWhenDeployed() public view {
    ...
    function testDontAllowPlayersToEnterWhileRaffleIsCalculating() public {
        ...
        raffle.enterRaffle{value: entranceFee}();
        // wait??
        vm.warp(block.timestamp + interval + 1); // guarantee to be past deadline
        vm.roll(block.number + 1); // simulate 1 new block is added
    ...
    function testFulfillrandomWordsPicksAWinnerResetsAndSendsMoney() public raffleEntered skipFork {
        ...
        Vm.Log[] memory entries = vm.getRecordedLogs();
        bytes32 requestId = entries[1].topics[1];
        // pretend to be chainlink node to call fulfillRandomWords
